          ...
          <div v-if="blogs">
            <div v-if="$page.allBlog.totalCount !== 0">
              <div class="ui centered stackable cards">
                <div
                  v-for="(blog, index) in $page.allBlog.edges"
                  :key="index"
                  class="card"
                >
                  <div class="image">
                  ...
                  <div class="content">
                    ...
                    <div class="description">{{ blog.node.excerpt }}...</div>
                  </div>
                  <div class="extra content">
                    <g-link
                      :to="blog.node.path"
                      class="lscs_blue link right floated"
                      >Read More</g-link
                    >
                  </div>
                </div>
            ...
            <div v-else class="ui buttons container">
              <h4 class="lscs_blue">
                There are no blogs yet. Please wait for further announcements!
              </h4>
            </div>
          </div>
        </transition>
